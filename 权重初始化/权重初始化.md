...
![Xavier正态分布-pytorch](Xavier正态分布-pytorch.png)

### Xavier初始化（均匀分布）

> torch.nn.init.xavier_uniform_函数。

![Xavier均匀分布-pytorch](Xavier均匀分布-pytorch.png)

### He初始化（正态分布）

> torch.nn.init.kaiming_normal_函数。

![He正态分布-pytorch](He正态分布-pytorch.png)

### He初始化（均匀分布）

> torch.nn.init.kaiming_uniform_函数。

![He均匀分布-pytorch](He均匀分布-pytorch.png)